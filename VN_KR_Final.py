...
vowels = {'a':'ㅏ','â':'ㅓ','o':'ㅗ','u':'ㅜ','i':'ㅣ','y':'ㅣ','e':'ㅔ','ê':'ㅔ','ư':'ㅡ',
          ...
          'ươi':'ㅡ어이','uoi':'ㅡ어이','uôi':'ㅜ어이','uya':'ㅟ어','uyê':'ㅟ어','uye':'ㅟ어','iêu':'ㅣ어우','yêu':'이어우','yeu':'이어우','ươu':'ㅡ어우','uây':'ㅝ이','oai':'ㅘ이',
...
while ans:
    ...
    """)
    print('*'*50)
    ans= input("뭐하실 겁니까? 선택하세요: >>> ")
    if ans=="1":
      s= input('원하실 것을 입력하세요: \n>>>')
      words = s.lower()
      print('\n')
      print("영어: ", end='')
      vn_eng(words)
